            ...
            <>
                ...
                <div className="rightbarFollowings">
                    ...
                    <div className="rightbarFollowing">
                        ...
                        <span className="rightbarFollowingName"> Jony Doe</span>
                    </div>
                    <div className="rightbarFollowing">
                    ...
                    <div className="rightbarFollowing">
                        ...
                        <span className="rightbarFollowingName"> Joser Doe</span>
                    </div>
                    <div className="rightbarFollowing">
                        <img src="assets/person/6.jpeg" alt="" className="rightbarFollowingImg" />
                        <span className="rightbarFollowingName"> Josli Doe</span>
                    </div>
                    <div className="rightbarFollowing">
                        <img src="assets/person/7.jpeg" alt="" className="rightbarFollowingImg" />
                        <span className="rightbarFollowingName"> Josher Doe</span>
                    </div>
                    <div className="rightbarFollowing">
                        <img src="assets/person/8.jpeg" alt="" className="rightbarFollowingImg" />
                        <span className="rightbarFollowingName"> Josha Doe</span>
                    </div>
                </div>
            </>
        )
